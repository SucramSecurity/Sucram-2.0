...
Sucram 2.0 is composed of several core modules:
...
Each module works together to provide continuous, adaptive, and explainable security.
...
Sucram 2.0 is planned to be released under the **Apache 2.0 License**.